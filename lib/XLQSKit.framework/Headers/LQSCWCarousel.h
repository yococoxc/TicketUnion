...
#import "LQSCWCarouselProtocol.h"
#import "LQSCWFlowLayout.h"


@interface LQSCWCarousel : UIView
...
/**
 相关代理
 */
@property (nonatomic, assign) id <LQSCWCarouselDelegate> _Nullable delegate;


/**
 相关数据源
 */
@property (nonatomic, assign) id <LQSCWCarouselDatasource> _Nullable datasource;


/**
 布局自定义layout
 */
@property (nonatomic, strong, readonly) LQSCWFlowLayout    * _Nonnull flowLayout;


/**
 样式风格
 */
@property (nonatomic, assign, readonly) LQSCWCarouselStyle   style;


/**
 style = LQSCWCarouselStyle_H_3时的扩展高度 (1.1.0版本后该属性废弃,请不要使用了)
 */
...
/**
 自定义的pageControl
 */
@property (nonatomic, strong) UIView<LQSCWCarouselPageControlProtocol> * _Nullable customPageControl;
...
- (instancetype _Nullable )initWithFrame:(CGRect)frame
                                delegate:(id<LQSCWCarouselDelegate> _Nullable)delegate
                              datasource:(id<LQSCWCarouselDatasource> _Nullable)datasource
                              flowLayout:(nonnull LQSCWFlowLayout *)flowLayout;
