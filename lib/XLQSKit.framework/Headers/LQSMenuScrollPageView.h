...
//指定大小。仅适用于LQSMenuStyleDynamicCustom。
- (CGFloat) lqsMenuScrollPageView:(LQSMenuScrollPageView *)view dynamicWidthOfView:(UIView *)itemView inLQSMenuAtIndex:(NSUInteger)index;
...
- (void) lqsMenuScrollPageView:(LQSMenuScrollPageView *)view scrollWithIndex:(NSInteger)index;
...
//0
@property(nonatomic,assign) CGFloat menuScrollGap;
